...
| Beam.cloud (beam.cloud) | **GPU render farm** (RTX 4090 serverless) | 3 workspaces, API tokens (see `docs/beam_cloud.md`) | ✅ active | Owner's own accounts, each with $30/month credit. Tokens in the private store only. Primary renderer since 2026-09-02. |
